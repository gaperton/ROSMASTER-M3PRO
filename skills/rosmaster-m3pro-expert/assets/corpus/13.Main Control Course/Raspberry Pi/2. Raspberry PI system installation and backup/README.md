...
5. Edit Settings allows you to set up your Raspberry Pi before booting it for the first time. You can pre-configure: username and password, WiFi credentials, device hostname, time zone, your keyboard layout, remote connection. As shown below:
