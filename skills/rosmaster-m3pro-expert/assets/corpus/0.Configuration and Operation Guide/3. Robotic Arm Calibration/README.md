...
Finally, press the space bar to complete the offset calibration. The calibrated offset data is saved in yahboomcar\_ws/src/arm\_kin/param/offset\_value.yaml.

Run the program to compile the arm\_kin function package to make the updated calibration file effective.
...
colcon build --packages-select arm\_kin