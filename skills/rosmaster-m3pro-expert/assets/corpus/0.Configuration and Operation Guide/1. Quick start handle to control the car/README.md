...
| Left "1" button           | Robotic arm No. 6 servo gripper (Tight)/No. 5 servo turn right |
| Left "2" button           | Robotic arm No. 6 servo gripper (Loose)/No. 5 servo turn left     |
| SELECT button             | Switch control robotic arm No. 6/No. 5 servo                     |
...
Cut joy_control.desktop to the ~ directory. It is recommended to save this file. Next time you want to restore handle control at startup, just copy it to the ~/.config/autostart directory.
