...
Create a folder to store the project files. yahboomcar\_ws is the folder name; you can name it anything.
...
A typical workspace structure in the ROS system is shown above. yahboomcar\_ws is the root directory of the workspace, which contains four subdirectories, or subspaces.
