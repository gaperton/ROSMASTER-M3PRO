...
SolidWorks model to URDF plugin: [sw\\_urdf\\_exporter - ROS Wiki](https://wiki.ros.org/sw_urdf_exporter)
...
Using the muto model as an example, copy the yahboomcar\_description package from this tutorial's folder to the src directory of your workspace:
...
colcon build --packages-select yahboomcar\_description

### **4.2. Model Visualization**

Refresh the environment variables and run the launch command.

ros2 launch yahboomcar\_description display.launch.py
