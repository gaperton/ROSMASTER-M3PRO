...
## 2. Backup (restore) system image on Windows
...
First create a new blank file with the.img suffix, then select read directly to back up the system, and then reinstall to restore it.
