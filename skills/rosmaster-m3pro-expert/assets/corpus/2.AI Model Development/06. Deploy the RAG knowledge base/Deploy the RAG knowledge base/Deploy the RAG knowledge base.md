...
#### **Deploying a Local RAG [Knowledge Base](#page-0-0)**

- <span id="page-0-0"></span>[1. Course](#page-0-1) Content
- [2. Starting](#page-0-2) the Dify Service
- 3. Viewing the Preset [Knowledge](#page-1-0) Base
- <span id="page-0-1"></span>[4. Expanding](#page-1-1) the RAG Knowledge Base
  - 4.1 [Economic Mode](#page-2-0) Knowledge Base
  - 4.2 [High-Quality](#page-4-0) Mode Knowledge Base
  - 4.3 [Recall](#page-5-0) Test
...
- <span id="page-0-2"></span>The RAG knowledge base can help robots quickly expand their generalization capabilities in different task scenarios.
...
<span id="page-1-0"></span>The preset knowledge base provides training examples for some task scenarios to help the AI model quickly master relevant skills.
...
<span id="page-1-1"></span>To expand with a new knowledge base, click "Create Knowledge".
...
- <span id="page-2-0"></span>The default knowledge base mode is High-Quality Mode.
...
- <span id="page-4-0"></span>If you need to use a high-quality knowledge base later, refer to this section of the tutorial.
...
- <span id="page-5-0"></span>Retrieval testing tests the actual effectiveness of retrieving relevant knowledge snippets from the knowledge base based on the input, helping to optimize the AI model's response performance.
