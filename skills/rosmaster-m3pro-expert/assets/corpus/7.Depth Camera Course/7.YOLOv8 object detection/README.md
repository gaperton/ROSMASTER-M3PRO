...
This lesson is for **Orin boards only**. It introduces the YOLOv8 framework and shows how to use it for object detection.

### 1.1 Introduction to YOLOv8

YOLOv8 is an object detection model released by Ultralytics in 2023. Compared with earlier YOLO versions, it improves accuracy, speed, and ease of use. It is widely used for computer vision tasks such as object detection, image segmentation, and pose estimation.
...
Visit the official Ultralytics documentation, [Explore Ultralytics YOLOv8](https://docs.ultralytics.com/models/yolov8/#performance-metrics), to download trained models and learn more about YOLOv8.
...
Open another terminal and start YOLOv8 object detection:
...
Select `/detect_image` in the upper-left corner and click the refresh button on the right to view the detection image, as shown below.
...
```text
/home/jetson/yahboomcar_ws/src/yahboom_yolov8/yahboom_yolov8/yolov8_track.py
```
...
Program initialization and publisher/subscriber definitions:
