...
Here we take serial port 1 as an example. UART1_TXD of serial port 1 corresponds to hardware PA9, UART1_RXD corresponds to hardware PA10, and the baud rate is set to 115200, 8-bit data, 1 stop bit, and no parity check.
