...
A complete table of contents for the ROSMASTER-M3PRO course corpus, grouped by what each course is *for* and kept in the original course-number order within each group. **Part A** is the embodied-AI brain (1–4). **Part B** is everything the robot does underneath it — driving, sensing, grasping, planning arm motion, and coordinating multiple robots (courses 5–11). **Part C** is the hardware (control-board firmware and compute boards), and **Part D** the software stack (Linux, ROS 2, Docker, OpenCV) you consult as reference. The standalone **Setup** section gets you to a first run.

**Setup**

- [0. Configuration & Operation Guide](#0-configuration-and-operation-guide)

**Part A — Embodied AI**

- [1. AI Model Basics](#1-ai-model-basics)
- [2. AI Model Development (Dify and RAG)](#2-ai-model-development-dify-and-rag)
- [3. AI Model — Text Version](#3-ai-model--text-version)
- [4. AI Model — Voice Version](#4-ai-model--voice-version)

**Part B — Operate the Robot**

- [5. Chassis Control](#5-chassis-control-course)
- [6. LiDAR](#6-lidar-course)
- [7. Depth Camera](#7-depth-camera-course)
- [8. MediaPipe Visual](#8-mediapipe-visual-course)
- [9. Robotic Arm & 3D Space Gripping](#9-robotic-arm-and-3d-space-gripping-course)
- [10. MoveIt2 Simulation](#10-moveit2-simulation-course)
- [11. Multi-vehicle](#11-multi-vehicle-course)

**Part C — Hardware**

- [12. Control Board (STM32 / micro-ROS)](#12-control-board-course)
- [13. Main Control (Compute Boards)](#13-main-control-course)

**Part D — Software & Foundations** *(reference)*

- [14. Linux System](#14-linux-system-course)
- [15. ROS 2 Basics](#15-ros-2-basic-course)
- [16. Docker](#16-docker-course)
- [17. Image-Processing Basics (OpenCV)](#17-image-processing-basics-course)
...
*STM32 / micro-ROS control-board firmware.*
