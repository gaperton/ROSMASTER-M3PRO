...
# <span id="page-3-1"></span>**4. Code Analysis**
...
# <span id="page-3-2"></span>**5. Solutions to Common Problems**

### <span id="page-4-0"></span>**5.1 Microphone Recording is Too Sensitive**
...
### <span id="page-5-0"></span>**5.2 Microphone Recording Insensitivity**
...
<span id="page-5-1"></span>If the microphone sensitivity is adjusted too high, it may increase the misidentification of environmental noise, treating environmental noise as voice activity.

### **5.3 Software Adjustment of Speech Recognition Sensitivity**

The configuration file path for the multi\_brains package is:

```
~/M3Pro_ws/multi_brains_file/multi_brains_setting.yaml
```

Find the VAD\_MODE parameter. The parameter range is 1-3; a higher number indicates higher sensitivity of VAD voice activity detection.
