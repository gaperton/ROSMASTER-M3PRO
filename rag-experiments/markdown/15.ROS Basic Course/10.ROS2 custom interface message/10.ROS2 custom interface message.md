...
1. In the [ROS2 Action Communication Server Implementation] course, we created a custom interface package. Create a folder called msg in the package pkg\_interfaces and a file called **Person.msg** in the msg folder. Enter the following content in the file:
...
colcon build --packages-select pkg\_interfaces
...
1. In the [ROS2 Action Communication Server Implementation] course, we created a custom interface function package. Create a new folder called srv under the function package pkg\_interfaces. Create a new file called Add.srv within the srv folder and enter the following content in the file:
