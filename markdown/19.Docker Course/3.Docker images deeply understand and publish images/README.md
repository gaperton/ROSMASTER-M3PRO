...
![](3、Docker-images-deeply-understand-and-publish-images.pdf-1-0.jpeg)
```
...
![](3、Docker-images-deeply-understand-and-publish-images.pdf-3-0.jpeg)


#### 3.4.2、Publish the image
The docker repository is a centralized storage place for image files. The largest public repository is

[Docker Hub (https://hub.docker.com/), which houses a huge number of images for users to](https://hub.docker.com/)
...
1. Address: [https://hub.docker.com/, register an account first](https://hub.docker.com/)
...
![](3、Docker-images-deeply-understand-and-publish-images.pdf-3-1.jpeg)
...
![](3、Docker-images-deeply-understand-and-publish-images.pdf-4-0.jpeg)


5、Visit Docker Hub to see that it has been successfully released


![](3、Docker-images-deeply-understand-and-publish-images.pdf-4-1.jpeg)
