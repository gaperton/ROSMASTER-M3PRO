...
![](7.Drive-motor.pdf-2-0.jpeg)

![](7.Drive-motor.pdf-2-1.jpeg)

![](7.Drive-motor.pdf-2-2.jpeg)

The corresponding relationship between the motor PWM drive GPIO is shown in the following
...
![](7.Drive-motor.pdf-3-0.jpeg)


First, initialize the configuration parameters of timer TIM1, set the division coefficient to 4, and the

counting range to 0~1999. Since the clock frequency of timer TIM1 is 240Mhz, the PWM frequency

is calculated to be 240000000/(4+1)/(1999+1)=24kHz.


![](7.Drive-motor.pdf-4-0.jpeg)
```
...
![](7.Drive-motor.pdf-8-0.jpeg)


将电机PWM通道与定时器的对应关系使用宏定义关联。


![](7.Drive-motor.pdf-8-1.jpeg)


由于电机的启动电压过低时无法转动，所以需要增加死区过滤，控制电机才更加敏捷。


![](7.Drive-motor.pdf-8-2.jpeg)


需要限制输入的PWM值。


![](7.Drive-motor.pdf-8-3.jpeg)


设置电机速度，传入电机ID值来区分电机，speed用来控制电机的速度，取值范围是
...
电机停止函数，brake函数为停止状态，brake=MOTOR_STOP表示自由停止，brake=MOTOR_BRAKE
...
![](7.Drive-motor.pdf-11-1.jpeg)
![](7.Drive-motor.pdf-12-0.jpeg)
...
The car motor moves forward for 1 second, stops for 1 second, moves backward for 1 second,
