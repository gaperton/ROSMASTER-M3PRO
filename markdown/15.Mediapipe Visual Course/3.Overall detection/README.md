...
## 1. Content Description
This course implements color image acquisition and uses the MediaPipe framework to perform

overall image detection, including faces, hands, and torsos.
...
in the terminal to start the overall detection program:


After the program is run, as shown in the figure below, the overall points detected will be

displayed on the right side of the image.


![](3.Overall-detection.pdf-1-0.jpeg)
## 3. Core code analysis
Program code path:
...
is `/root/yahboomcar_ws/src/yahboomcar_mediapipe/yahboomcar_mediapipe/03_Holistic.`
...
is `/home/jetson/yahboomcar_ws/src/yahboomcar_mediapipe/yahboomcar_mediapipe/03_Ho`
...
![](3.Overall-detection.pdf-1-1.jpeg)
...
![](3.Overall-detection.pdf-2-0.jpeg)
