...
This course implements color images and uses the mediapipe framework to detect fingers. It then

calculates the angles formed by the thumb tip, wrist joint, and index finger tip to change the effect
...
in the terminal to start the finger control program.


After the program is running, press the F key to switch the image processing effect, and then

change the angle by changing the distance between the thumb and index finger to control the

image processing effect.


![](9.Finger-control.pdf-0-2.jpeg)
![](9.Finger-control.pdf-1-0.jpeg)
...
is `/root/yahboomcar_ws/src/yahboomcar_mediapipe/yahboomcar_mediapipe/10_HandCtrl.`
...
is `/home/jetson/yahboomcar_ws/src/yahboomcar_mediapipe/yahboomcar_mediapipe/10_Ha`
...
![](9.Finger-control.pdf-3-0.jpeg)


As shown in the figure below, the ID of each joint of the finger,


![](9.Finger-control.pdf-4-0.jpeg)

calc_angle calculates the angle, here we calculate the angle between the thumb tip, wrist joint and

index finger tip.


![](9.Finger-control.pdf-4-1.jpeg)
