...
This course implements color image acquisition and fingertip detection using the MediaPipe

framework. Gestures are used to start and stop recording fingertip trajectories within the image.

After recording is complete, a fingertip trajectory map is generated and the trajectory is
...
in the terminal to start the fingertip trajectory recognition program:
...
![](11.Fingertip-trajectory-recognition.pdf-1-0.jpeg)
...
![](11.Fingertip-trajectory-recognition.pdf-1-1.jpeg)
![](11.Fingertip-trajectory-recognition.pdf-2-0.jpeg)
...
![](11.Fingertip-trajectory-recognition.pdf-2-1.jpeg)
![](11.Fingertip-trajectory-recognition.pdf-3-0.jpeg)

Note: The drawn graphics need to be closed, otherwise some content may be missing.


There are currently four trajectory shapes that can be recognized, namely: triangle, rectangle,

circle, and five-pointed star
...
is `/root/yahboomcar_ws/src/yahboomcar_mediapipe/yahboomcar_mediapipe/15_FingerTra`
...
is `/home/jetson/yahboomcar_ws/src/yahboomcar_mediapipe/yahboomcar_mediapipe/15_Fi`
...
![](11.Fingertip-trajectory-recognition.pdf-3-1.jpeg)
...
![](11.Fingertip-trajectory-recognition.pdf-7-0.jpeg)

![](11.Fingertip-trajectory-recognition.pdf-7-1.jpeg)
