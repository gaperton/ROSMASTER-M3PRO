...
| ROS2 version        | Release date | Maintenance<br>deadline | Ubuntu version                                            |
|---------------------|--------------|-------------------------|-----------------------------------------------------------|
...
ROS 1 compiles using the catkin\_make command, while ROS 2 compiles using the colcon build command.