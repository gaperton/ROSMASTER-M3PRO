...
This course explains how to use functions in the MoveIt library to implement forward kinematics

for a robotic arm. Forward kinematics involves calculating the pose of the robotic arm's end

effector based on joint angles. In rviz, we specify the angles for each joint and have MoveIt2

program the robot to achieve these poses.
...
Then enter the following command in the terminal to start the positive kinematics design

program,


![](4.Forward-kinematics-design.pdf-0-1.jpeg)


After the program runs, the robotic arm in rviz will plan to move to the posture of each joint we
...
![](4.Forward-kinematics-design.pdf-1-0.jpeg)
```
