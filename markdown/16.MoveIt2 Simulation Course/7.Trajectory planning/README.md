...
This section explains how to display the path planned by MoveIt. The robot arm moves along the
...
![](7.Trajectory-planning.pdf-0-1.jpeg)
![](7.Trajectory-planning.pdf-1-0.jpeg)

Next, we modify the topics that need to be displayed, as shown below.


Finally, we enter the following command in the virtual machine terminal to start the trajectory

planning program,


![](7.Trajectory-planning.pdf-1-1.jpeg)


After the program runs, the trajectory is displayed in rviz and the robotic arm moves along the

trajectory, as shown in the figure below.


![](7.Trajectory-planning.pdf-2-0.jpeg)
