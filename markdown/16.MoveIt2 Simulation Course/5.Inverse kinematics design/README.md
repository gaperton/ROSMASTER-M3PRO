...
for a robotic arm. Forward kinematics involves calculating the required joint angles based on the

desired pose of the end effector. In rviz, we assign the end effector a pose and have MoveIt2 plan
...
Then enter the following command in the terminal to start the inverse kinematics design

program,


![](5.Inverse-kinematics-design.pdf-0-1.jpeg)


After the program runs, the robotic arm in rviz will plan to move to the position we set, as shown
...
![](5.Inverse-kinematics-design.pdf-1-0.jpeg)
```
