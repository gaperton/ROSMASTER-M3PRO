...
|                                   | POE via separate new POEHAT<br>(Change of network port position) | POE via the stand-alone POEHAT                 |
...
| Fan interface                     | PWM control and tacho Feedback<br>(4 pins JST)                   | None                                           |
