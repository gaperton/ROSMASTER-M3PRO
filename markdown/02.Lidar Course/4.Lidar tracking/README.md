...
the nearest object to the vehicle in real time and control the chassis to track it.
...
After the program is started, the radar will scan the object closest to the car within the detection

range and slowly move the object. The program will control the chassis to move, maintain a

distance of 0.55 meters from the object and align the front of the car with the object.
...
/root/yahboomcar_ws/src/yahboom_M3Pro_laser/yahboom_M3Pro_laser/laser_Tracker.py
...
/home/jetson/yahboomcar_ws/src/yahboom_M3Pro_laser/yahboom_M3Pro_laser/laser_Trac
