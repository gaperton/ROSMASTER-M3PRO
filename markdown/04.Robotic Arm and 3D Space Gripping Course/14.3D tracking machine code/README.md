...
This function implements a program that captures images from a camera and recognizes

machine codes. The machine codes move up and down, left and right, and forward and backward,

and the robotic arm follows the machine codes.
...
Then, open another terminal and enter the following command to start the 3D tracking machine

code program.


After the program is started, the robotic arm will move to the tracking posture, holding a
## 40x40x40mm machine code wooden block, as shown in the figure below.


![](14.3D-tracking-machine-code.pdf-1-0.jpeg)

Then press the space bar to start tracking and slowly move the robot code block. The program will

calculate the position changes in the machine code space and then control the robotic arm to

track the machine code.
...
![](14.3D-tracking-machine-code.pdf-5-0.jpeg)
